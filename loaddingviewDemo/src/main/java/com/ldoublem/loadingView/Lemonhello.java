...
import github.devwilliamzhang.library.lemonbubble.LemonBubble;
import github.devwilliamzhang.library.lemonbubble.LemonBubbleGlobal;
import github.devwilliamzhang.library.lemonbubble.enums.LemonBubbleLayoutStyle;
import github.devwilliamzhang.library.lemonbubble.enums.LemonBubbleLocationStyle;
import github.devwilliamzhang.library.lemonhello.LemonHello;
import github.devwilliamzhang.library.lemonhello.LemonHelloAction;
import github.devwilliamzhang.library.lemonhello.LemonHelloGlobal;
import github.devwilliamzhang.library.lemonhello.LemonHelloInfo;
import github.devwilliamzhang.library.lemonhello.LemonHelloView;
import github.devwilliamzhang.library.lemonhello.adapter.LemonHelloEventDelegateAdapter;
import github.devwilliamzhang.library.lemonhello.interfaces.LemonHelloActionDelegate;

public class Lemonhello extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lemonhello);
    ...
    private void initFunctions() {
                ...
                LemonHello.getWarningHello("您确认删除这条数据吗？", "删除这条数据后会同时删除其关联的数据，并且无法撤销！")
                        ...
                        .addAction(new LemonHelloAction("确定删除", Color.RED, new LemonHelloActionDelegate() {
                            ...
                            public void onClick(LemonHelloView helloView, LemonHelloInfo helloInfo, LemonHelloAction helloAction) {
                                ...
                                LemonBubble.showRoundProgress(Lemonhello.this, "正在删除中...");
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        LemonBubble.showRight(Lemonhello.this, "删除成功", 1000);
                                    }
                                }, 2000);
                            }
                        }))
                        ...
                        .addAction(new LemonHelloAction("我要注销", Color.RED, new LemonHelloActionDelegate() {
                            ...
                            public void onClick(LemonHelloView helloView, LemonHelloInfo helloInfo, LemonHelloAction helloAction) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        LemonBubble.showRight(Lemonhello.this, "注销成功，欢迎您下次登录", 2000);
                                    }
                                }, 1500);
                            }
                        }))
            ...
            public void onClick(View v) {
                LemonHelloInfo bookMarkInfo = new LemonHelloInfo()
                        ...
                        .addAction(new LemonHelloAction("添加", new LemonHelloActionDelegate() {
                            ...
                            public void onClick(LemonHelloView helloView, LemonHelloInfo helloInfo, LemonHelloAction helloAction) {
                                helloView.hide();
                                LemonBubble.showRight(Lemonhello.this, "添加成功", 1500);
                            }
                        }));
                bookMarkInfo.show(Lemonhello.this);
            }
        });
        ...
        btn_multiMessages.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                info1.show(Lemonhello.this);
                info2.show(Lemonhello.this);
                info3.show(Lemonhello.this);
            }
        });
