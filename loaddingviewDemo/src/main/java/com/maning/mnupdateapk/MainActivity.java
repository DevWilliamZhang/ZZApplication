...
import github.devwilliamzhang.library.updatelibrary.InstallUtils;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.btnDownloadBrowser) {//通过浏览器去下载APK
            InstallUtils.installAPKWithBrower(this, Constants.APK_URL_02);

        } else if (i == R.id.btnDownload) {//申请SD卡权限
